...
class New_ExtSupplierUI {
    ...
    private void initialize() {
        ...
        this.frame.getContentPane().add(this.CompanyName);
        ...
        this.frame.getContentPane().add(this.EEmailField);
        ...
        this.frame.getContentPane().add(this.EPhoneField);
        ...
        this.frame.getContentPane().add(this.EFAddressField);
        ...
        this.frame.getContentPane().add(this.AmtEggField);
        ...
        this.frame.getContentPane().add(btnEditExistingSuppliers);
        ...
        this.frame.getContentPane().add(btnDeleteSupplier);
