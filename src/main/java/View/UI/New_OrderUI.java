...
public class New_OrderUI extends JFrame {
    ...
    public New_OrderUI() throws IOException {
        this.initialize();
    }
    ...
    private void initialize() throws IOException {
        ...
        getContentPane().add(this.CustomerField);
        ...
        getContentPane().add(this.deliveryField);
        ...
        getContentPane().add(this.AmtField);
        ...
        getContentPane().add(lblEnterType);
